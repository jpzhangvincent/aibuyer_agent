...
from aibuyer_agent import get_aibuyer_agent
...
app = FastAPI(
    title="AI Buyer Agent API",
    version="1.0",
    description="AI Buyer Agent API that retrun the chatbot response",
)
...
cityhub_agent = get_aibuyer_agent()
